...
export type WaterTypeOption = {
  id: WaterType;
  title: string;
  description: string;
  icon: string;
  requiresAltitudeOption: boolean;
};
...
export const WATER_TYPE_OPTIONS: WaterTypeOption[] = [
  {
    id: "saltwater",
    title: "Agua salada",
    description: "Mar, puerto marítimo u operación offshore. Altitud no requerida por defecto.",
    icon: "🌊",
    requiresAltitudeOption: false
  },
  {
    id: "freshwater",
    title: "Agua dulce",
    description: "Lago, río, cantera, represa u obra interior. Debe contemplar altitud.",
    icon: "🏞️",
    requiresAltitudeOption: true
  }
];
...
export const ALTITUDE_SOURCE_OPTIONS: {
  id: AltitudeSource;
  title: string;
  description: string;
}[] = [
  {
    id: "pending",
    title: "Confirmar después",
    description: "Permite seguir con el prototipo visual, pero bloqueará cálculos futuros."
  },
  {
    id: "manual",
    title: "Ingresar manualmente",
    description: "Dato cargado por el usuario o supervisor."
  },
  {
    id: "gps_estimated",
    title: "GPS del teléfono",
    description: "Preparado para una fase posterior. Debe mostrarse como estimación."
  }
];
...
export const APP_COPY = {
  ...
  productSubtitle: "Recreational Air Planning Prototype",
  prototypeWarning:
    "Prototipo recreativo con aire. Usa Tabla I como dataset candidato validado para pruebas controladas.",
  operationalWarning:
