...
export function StartScreen({ onStart, onDemo }: StartScreenProps) {
  return <section className="screen screen--hero"><div className="brand-block"><span className="eyebrow">RECREATIONAL MODE · PROTOTYPE v2.0</span><h1>{APP_COPY.productName}</h1><p>Air dive planning · Tabla I · Detalle del cálculo</p></div>
    ...
    <div className="content-card"><h2>Esta versión permite:</h2><ul className="clean-list"><li>✓ Gas: aire</li><li>✓ Métrico e imperial</li><li>✓ Profundidad con redondeo hacia arriba</li><li>✓ Tiempo exacto contra límite de Tabla I</li><li>✓ Resultado simple + Detalle del cálculo</li><li>✓ Checklist de validación manual</li></ul></div>
