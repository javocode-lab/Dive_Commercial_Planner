...
type ValidationKey = "inputReviewed" | "conversionsReviewed" | "rulesReviewed" | "pressureGroupReviewed" | "resultReviewed" | "warningsReviewed" | "notAuthorizationAccepted";
...
const ITEMS: { key: ValidationKey; label: string; description: string }[] = [
  ...
  { key: "pressureGroupReviewed", label: "Grupo de presión revisado", description: "Se revisó si el grupo final está disponible o pendiente de dataset antes de usarlo para repetitivas." },
